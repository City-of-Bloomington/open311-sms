...
(29,'REPLY_WITH_DESCRIPTION','Reply with description of issue','SubmitRequestInteractionMode'),
...
(35,'HELP_INTRO_PAGE','Reply "1" for help on getting service codes;"2" for help on submitting service request;"3" for help onchecking service request status','HelpInteractionMode'),
...
(44,'SMS_ERROR_SERVICE_CODE_NOT_PRESENT','No Service Code was present in your request.Reply "help"to get help on sumitting Service Requests.','Error'),
...
(47,'SMS_ERROR_NO_SERVICE_REQUEST_ID_PRESENT','No Service Request Id was present in your request.Reply"help"to get help on checking request status.','Error');
